package com.jzgame.modules.lobby
{
	...
	public class GamelListItem extends DefaultListItemRenderer
	{
		...
		override protected function initialize():void
		{
			...
			_target = new Button;
			this.addEventListener(Event.TRIGGERED,someEventHandler);
			addChild(_target);
...
//			this.dispatchEventWith( Event.TRIGGERED );
			...
			SignalCenter.onGameTriggered.dispatch(this.index);
		}
...
//			}
		...
		override public function dispose():void
		{
			super.dispose();
			_target.dispose();
			this.removeEventListener(TouchEvent.TOUCH, touchMeHandler);
			this.removeEventListener(Event.TRIGGERED,someEventHandler);
			_data = null;
			_owner = null;
		}
	}
