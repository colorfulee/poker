...
//			Config.log(className, 'addToLoad', "FileName: " + fileName + " || FullPath: " + fullPath + " || ext: " + ext);
			...
			switch(ext) {
				...
				case AssetsCenter.FNT:
					queue.append(new XMLLoader(fullPath, {'name':id,"noCache":false,"auditSize":false}));
					break;
				
				case AssetsCenter.JPG:
				case AssetsCenter.PNG:
					queue.append(new ImageLoader(fullPath, {'name':id,"noCache":false,"auditSize":false}));
					break;
				
				case AssetsCenter.JSN:
					queue.append(new DataLoader(fullPath, {'name':id,"noCache":false,"auditSize":false}));
					break;
				
				case AssetsCenter.MP3:
					queue.append(new MP3Loader(fullPath, {'name':id, 'autoPlay': false,"noCache":false,"auditSize":false}));
					break;
			}
