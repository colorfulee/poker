...
//			_head = "release/0.0.2/";
		...
		{
			return getFullPath(ASSETS+SOUND+id + MP3);
		}
		/**
		 * 转换成xml
		 * @param bytes
...
//			https://graph.facebook.com/{facebookId}/picture?type=square
		...
		{
			return getFullPath(COMMON + IMAGES + "pokerJ_icon.png");
		}
		/**
		 * 获取道具图片地址
		 * @param name
		...
		{
			return getFullPath(ASSETS + "04/" +name + PNG);
		}
		
		public static function getDyImagePath(name:String):String
		{
			return getFullPath(ASSETS + IMAGES +name + JPG);
		}
		...
		{
			return getFullPath(ASSETS + 'launch/' + img);
		}
