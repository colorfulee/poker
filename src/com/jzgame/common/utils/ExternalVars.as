...
public class ExternalVars
{
    ...
    //  Class Methods
    //==========================================================================
    static public function initialize(info:Object):void
    {
//        loaderInfo = info;
//        isDebug = CONFIG::debugging;
        var playerType:String = Capabilities.playerType;
		trace('playerType:',playerType);
...
//				local = local.slice(0, lastIndex);
			...
			if (params.hasOwnProperty("socket"))
			{
				socketURL = params["socket"];
				gateway = params["socket"];
			}
			...
			if (params.hasOwnProperty("info_url"))
			{
				gateway = params["info_url"];
			}
...
//				configSource = "https://g1.dev.jizeipoker.gamagic.com/json/static.json";
	...
	//socket url
	static public var socketURL:String = "192.168.1.52:9688";
...
//	static public var appID:String = "1017916871551726";
	 ...
	 * 调用PHP API的地址
	 */	
	static public var gateway:String = "http://192.168.1.44/j21/info.php";
